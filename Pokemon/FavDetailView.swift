...
//  Pokemon
//
//  Created by Ofelia Y. Lizcano Méndez on 14/06/21.
//
        ...
        ZStack{
            ...
            VStack{
                HStack {
                    ...
                    Spacer()
                    VStack {
                        if media.setFavorite2(pokemon: pokemon) == false {
                            Button(action: {
                                media.AddToFavorites2(pokemon: pokemon)
                            ...
                            Button(action: {
                                    media.removeFavorites2(pokemon: pokemon)
